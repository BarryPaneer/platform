...
CELERY_IMPORTS = ('cms.djangoapps.contentstore.tasks', 'openedx.core.djangoapps.bookmarks.tasks')
...
# Use the CMS specific programs filter generator
PROGRAM_SEARCH_FILTER_GENERATOR = 'cms.lib.course_search.cms_filter_generator.CmsProgramSearchFilterGenerator'
...
DEFAULT_ASSIGNMENT_THRESHOLD = 80
