...
def initialize_permissions(course_key, user_who_created_course):
    ...
    # Update: Enrolling the course creator as a student was disabled below to prevent unnecessary
    # course grade updates when accessing student dashboard after a platform admin adds a large
    # number of courses.
