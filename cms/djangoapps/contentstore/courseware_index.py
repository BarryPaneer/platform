...
class CourseAboutSearchIndexer(object):
    ...
    ABOUT_INFORMATION_TO_INCLUDE = [
        ...
        AboutInfo("duration", AboutInfo.ANALYSE, AboutInfo.FROM_ABOUT_INFO),
        ...
        AboutInfo("duration", AboutInfo.PROPERTY, AboutInfo.FROM_COURSE_PROPERTY),
        ...
        AboutInfo("enrollment_learning_groups", AboutInfo.PROPERTY, AboutInfo.FROM_COURSE_PROPERTY)
    ]
