...
from lms.djangoapps.teams.views import ProgramTeamMembers
from lms.djangoapps.teams.views import ProgramDetail
...
urlpatterns = [
    ...
    url(r'^program_search/$', contentstore.views.program_discovery, name='program_search'),
    ...
    url(r'^program_team/', ProgramTeamMembers.as_view(), name='program'),
    url(r'^program_detail/', ProgramDetail.as_view(), name='program_detail'),
    ...
    url(r'^get_encoded_video_url/{}(?:/(?P<edx_video_id>[-\w]+))?$'.format(settings.COURSE_KEY_PATTERN),
        contentstore.views.get_encoded_video_url, name='encoded_video_url'),
