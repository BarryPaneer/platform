...
define(['jquery', 'underscore', 'gettext', 'common/js/components/utils/view_utils', 'js/utils/module',
    ...
    function($, _, gettext, ViewUtils, ModuleUtils, XBlockInfo, StringUtils) {
        ...
        var addXBlock, duplicateXBlock, deleteXBlock, createUpdateRequestData, updateXBlockField, VisibilityState,
            ...
            moveXBlock, validateXBlockRequestData;
        ...
        createUpdateRequestData = function(fieldName, newValue) {
         ...
         /**
         * Validate the value against emoticons if emoticons found show warning message
         * @param {*} value The value to validate.
         * @returns {true of fase} A boolean to show validation check status.
         */
        validateXBlockRequestData = function(newValue) {
            const reg = new RegExp(/[\u2700-\u27BF]|[\uE000-\uF8FF]|\uD83C[\uDC00-\uDFFF]|\uD83D[\uDC00-\uDFFF]|[\u2011-\u26FF]|\uD83E[\uDD10-\uDDFF]/g);
            if (reg.test(newValue)) {
                ViewUtils.showingErrorMessage(gettext('Emoticons are not allowed in Section/Subsection titles'))
                return false
            }
            return true
        }
        ...
        return {
            ...
            validateXBlockRequestData: validateXBlockRequestData
        };
    });
