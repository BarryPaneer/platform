...
class AccountViewSet(ViewSet):
    ...
    def get(self, request):
        ...
        #import crum
        language = user_timezone_locale_prefs(request)['user_language']
        ...
        elif STUDIO_ADMIN_ACCESS_GROUP in [group.name for group in request_user.groups.all()]:
            user_role = 'studio_admin'

        return Response(
            {
                'username': request_user.username,
                'language': language,
                'admin_type': user_role
            }
        )
