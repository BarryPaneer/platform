...
class UserAPITestCase(ApiTestCase):
    ...
    def assertUserIsValid(self, user):
        ...
        self.assertItemsEqual(
            user.keys(),
            ["email", "id", "name", "username", "preferences", "first_name", "last_name", "url"]
        )
        self.assertItemsEqual(
        ...
        self.assertEqual(
            self.get_json(uri),
            {
                "user": {
                    ...
                    'first_name': pref.user.first_name,
                    'last_name': pref.user.last_name,
...
class RegistrationViewTest(ThirdPartyAuthTestMixin, UserAPITestCase):
    ...
    @with_site_configuration(
        configuration={
            "REGISTRATION_FIELD_ORDER": settings.REGISTRATION_FIELD_ORDER + ["profession"]
        })
    ...
    @with_site_configuration(
        configuration={
            "REGISTRATION_FIELD_ORDER": settings.REGISTRATION_FIELD_ORDER + ["specialty"]
        })
