...
def wrap_xblock(
            ...
            frag_content = '''
                    <div class="colorful-boxes">
                        <div class="blue-block">
                            <span class="icon"><span class="far fa-text"></span></span>
                            <strong>{text_use_video}</strong>
                            <p>{text_add_videos}</p>
                        </div>
                        <div class="yellow-block">
                            <span class="icon"><span class="far fa-play"></span></span>
    ...
    if isinstance(block, (XModule, XModuleDescriptor)):
        ...
        if 'pytest' not in sys.modules:
            for chunk in webpack_loader.utils.get_files(class_name):
                frag.add_resource_url(chunk['url'], mimetype='application/javascript', placement='head')
