...
from lms.djangoapps.certificates.api import cert_self_generation_enabled
...
from xmodule.seq_module import is_vertical_completed
...
class CoursewareIndex(View):
    ...
    def _create_courseware_context(self, request):
        ...
        # get cert info
        certificate_enabled = cert_self_generation_enabled(self.course.id, self.course.self_paced)
        post_url = reverse('generate_user_cert', args=[unicode(self.course.id)])
            ...
            for section in sections:
                ...
                for sequence in sequences:
                    ...
                    if isinstance(sequence, VerticalBlock):
                        complete = is_vertical_completed(completion_service, sequence, user)
