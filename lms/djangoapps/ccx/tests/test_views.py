...
class TestCCXGrades(FieldOverrideTestMixin, SharedModuleStoreTestCase, LoginEnrollmentTestCase):
    ...
    def setUp(self):
        ...
        # create enrollment
        CourseEnrollmentFactory.create(user=coach, course_id=self.ccx_key)
    ...
    def test_gradebook(self):
        ...
        self.assertEqual(student_info['grade_summary']['percent'], 0)
        self.assertEqual(student_info['grade_summary']['grade_breakdown'].values()[0]['percent'], 0)
    ...
    def test_grades_csv(self):
        ...
        self.assertEqual(data['HW 01'], '0.0')
        self.assertEqual(data['HW 02'], '0.0')
        self.assertEqual(data['HW 03'], '0.0')
        self.assertEqual(data['HW Avg'], '0.0')
...
class CCXCoachTabTestCase(CcxTestCase):
    ...
    def test_ccx_tab_visibility_for_staff_ccx_course(self):
        ...
        with ccx_course(ccx_key) as course_ccx:
            ...
            self.assertTrue(not self.check_ccx_tab(course_ccx, staff))
    ...
    def test_ccx_tab_visibility_for_instructor_ccx_course(self):
        ...
        with ccx_course(ccx_key) as course_ccx:
            ...
            self.assertTrue(not self.check_ccx_tab(course_ccx, instructor))
