...
class RecalculateSubsectionGradeTest(HasCourseWithProblemsMixin, ModuleStoreTestCase):
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 2, 33, True),
        (ModuleStoreEnum.Type.mongo, 2, 33, False),
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 2, 33),
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 2, 19),
    ...
    @ddt.data(
        (ModuleStoreEnum.Type.mongo, 2, 34),
