...
class CourseListGetForm(UsernameValidatorMixin, Form):
    ...
    teams_courses_only = BooleanField(required=False)
    ...
    supported_filters = [
        ...
        filter_type(param_name='display_name', field_name='display_name__icontains'),
        filter_type(param_name='teams_courses_only', field_name='teams_courses_only')
    ]
