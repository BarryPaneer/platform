...
FEATURES = {
    ...
    'ENABLE_UNENROLLMENT_TRACKING': False,
...
HEARTBEAT_CHECKS = [
    ...
    'openedx.core.djangoapps.heartbeat.default_checks.check_elasticsearch',
]
...
HEARTBEAT_ELASTICSEARCH_TIMEOUT = 2
...
#################### Edx Objects MongoDB Settings #################################

EDX_OBJECTS_MONGODB_SETTINGS = {
    'programs': {
        'db': 'programs',
        'host': 'localhost',
        'port': 27017,
...
base_vendor_js = [
    ...
    'common/js/vendor/vue.js',
    'common/js/vendor/vue-resource.js',
    'common/js/vendor/papaparse.js',
...
DEFAULT_FONT_SANS_SERIF = 'NotoSans'
...
CELERY_IMPORTS = (
    ...
    'openedx.core.djangoapps.heartbeat.tasks',
    'poll.tasks',
)
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'common.djangoapps.util.exception_handler.learning_tribes_exception_handler'
}
...
# Use the LMS specific filter generator
PROGRAM_SEARCH_FILTER_GENERATOR = 'lms.lib.courseware_search.lms_filter_generator.LmsProgramSearchFilterGenerator'
...
COURSE_CATALOG_API_URL = 'http://127.0.0.1:18381/api/v1/'
...
PROFILE_IMAGE_SECRET_KEY = 'fnauibnerkfuibanuier'
