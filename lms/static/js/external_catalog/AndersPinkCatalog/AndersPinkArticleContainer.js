...
export class AndersPinkArticleContainer extends React.Component {
    constructor(props) {
        super(props);
        ...
        this.all_options = Array(
                ['+display_name_time', gettext('Most Recent').trim()],
                ['-display_name_time', gettext('Oldest').trim()],
    ...
    render() {
        ...
        return (
            <main className="course-container">
                <div><i className={`far fa-indent ${this.props.indent ? 'hidden' : ''}`}
