        ...
        function($, utility, _, _s, Backbone, LoginModel, PasswordResetModel, RegisterModel, LoginView,
            ...
            // The form currently loaded
                ...
                // The login view listens for 'sync' events from the reset model
                    ...
                    this.register_user_url = options.register_user_url;

                    this.prioritize_email_login = options.prioritize_email_login;
                ...
                load: {
                    login: function(data) {
                        ...
                        this.subview.login = new LoginView({
                            ...
                            prioritize_email_login: this.prioritize_email_login
                        });
