        ...
        function(
            ...
            // These are reset to true on form submission.
                ...
                renderFields: function (fields) {
                    ...
                    html.push('<div class="field-group">');
                ...
                buildForm: function(data) {
                    ...
                    html = this.renderFields(allFields);
                ...
                postRender: function() {
                    ...
                    // }
                    // xss-lint: disable=javascript-jquery-insert-into-target
                    $('.checkbox-honor_code').insertAfter('.field-group');
                    // xss-lint: disable=javascript-jquery-insert-into-target
                    $('.checkbox-terms_of_service').insertAfter('.field-group');
                    // xss-lint: disable=javascript-jquery-insert-into-target
                    $('.plaintext-honor_code').insertAfter('.field-group');
