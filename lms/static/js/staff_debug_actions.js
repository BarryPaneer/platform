    ...
    var doInstructorDashAction = function(action) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                var html = _.template('<p id="idash_msg" class="success"><i class="far fa-check"></i><span>{text}</span></p>', {interpolate: /\{(.+?)\}/g})(
                {text: text}
            );
            ...
            error: function(request, status, error) {
                ...
                var html = _.template('<p id="idash_msg" class="error"><i class="far fa-times"></i><span>{text}</span></p>', {interpolate: /\{(.+?)\}/g})(
                {text: text}
            );
                $('#result_' + sanitizeString(action.locationName)).html(html);
            },
