...
class TestPaverAssetTasks(PaverTestCase):
    ...
    def test_compile_sass(self, options):
        ...
        expected_messages.append(u'rtlcss common/static/css/fontawesome/sharp-solid.css common/static/css/fontawesome/sharp-solid-rtl.css')
        expected_messages.append(u'rtlcss common/static/css/fontawesome/thin.css common/static/css/fontawesome/thin-rtl.css')
