...
def node_prereqs_installation():
    ...
    # We are facing a dependency issue due to differences between ci/product environments
    # and choose to bypass it by deleting the package-lock.json temporarily
    if Env.TESTING and os.path.exists('package-lock.json'):
