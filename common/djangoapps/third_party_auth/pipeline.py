...
def user_details_force_sync(auth_entry, strategy, details, user=None, *args, **kwargs):
    ...
    if user and current_provider.sync_learner_profile_data:
        ...
        field_mapping.update({
            ...
            'lt_address': (user.profile, 'lt_address'),
            'lt_address_2': (user.profile, 'lt_address_2'),
            'lt_comments': (user.profile, 'lt_comments'),
            'lt_company': (user.profile, 'lt_company'),
            'lt_custom_country': (user.profile, 'lt_custom_country'),
            'lt_department': (user.profile, 'lt_department'),
            'lt_employee_id': (user.profile, 'lt_employee_id'),
            'lt_hire_date': (user.profile, 'lt_hire_date'),
            'lt_job_code': (user.profile, 'lt_job_code'),
            'lt_job_description': (user.profile, 'lt_job_description'),
            'lt_learning_group': (user.profile, 'lt_learning_group'),
            'lt_level': (user.profile, 'lt_level'),
            'lt_phone_number': (user.profile, 'lt_phone_number'),
            'lt_supervisor': (user.profile, 'lt_supervisor'),
            'lt_ilt_supervisor': (user.profile, 'lt_ilt_supervisor'),
            'lt_area': (user.profile, 'lt_area'),
            'lt_sub_area': (user.profile, 'lt_sub_area')
        })
