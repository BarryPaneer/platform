...
(function() {
    ...
    this.DiscussionUtil = (function() {
        ...
        DiscussionUtil.hideLoadingIndicator = function($_loading) {
            $_loading.remove();
        };
        ...
        DiscussionUtil.safeAjax = function(params) {
            ...
            if (params.$loading) {
                if (params.loadingCallback) {
                    ...
                    $_loading = self.showLoadingIndicator(params.$loading, params.takeFocus);
                }
            }
            ...
            request = $.ajax(params).always(function() {
                ...
                if (params.$loading) {
                    if (params.loadedCallback) {
                        ...
                        if ($_loading) self.hideLoadingIndicator($_loading);
                        return
                    }
                }
            });
