...
(function(define, require) {
    ...
    /* End Webpack */
            ...
            var toggleExpandCollapse, showLoadingIndicator, hideLoadingIndicator, confirmThenRunOperation,
                runOperationShowingMessage, showingErrorMessage, withDisabledElement, disableElementWhileRunning,
            ...
            /**
             * Show an Error message if the client side validation fails.
             */
            showingErrorMessage = function(message) {
                var notificationView;
                notificationView = new NotificationView.Error({
                    title: gettext(message)
                });
                notificationView.options.closeIcon = true
                notificationView.show();
            }
            ...
            return {
                ...
                showingErrorMessage: showingErrorMessage
            };
        });
